...
theme.font = "consolas 16"
beautiful.init(theme)
beautiful.hotkeys_font = "consola 12"
beautiful.hotkeys_description_font = "consola 12"
-- revelation.init()
-- zlk-theme ends here

-- This is used later as the default terminal and editor to run.
terminal = "xfce4-terminal"
editor = "vim"--os.getenv("EDITOR") or "nano"
...
awful.screen.connect_for_each_screen(function(s)
	...
	local names = {"main", "emacs", "chrome", "terminal", "idea", "office", "amuse", "vbox", "others"}
	local l = awful.layout.suit
	local layouts = {l.floating, l.tile, l.tile, l.tile, l.tile, l.tile, l.tile, l.max, l.floating}
	awful.tag(names, s, layouts)
	-- zlk-config ends here
...
--              {description = "show main menu", group = "awesome"}),
	...
	-- zlk-binding
		...
		awful.key({ modkey}, "Next",
				...
				{description = "transparent +0.1", group = "screen"}),
		...
		awful.key({ modkey, "Control" }, "p",
				...
				{description = "poweroff", group = "client"}),
		awful.key({modkey}, "g",
				function ()
		...
		awful.key({modkey},"z",
				...
				{description = "evince",  group = "launcher"}),
		--awful.key({ modkey }, "F8",
				--function ()
				--	awful.util.spawn("virtualbox")
				--end,
				-- {description = "VBox", group = "launcher"}),
		awful.key({ modkey }, "Up",
				function ()
				awful.util.spawn("netease-cloud-music")
				end,
				{description = "netease-cloud-music", group = "launcher"}),
		awful.key({ modkey, "Control" }, "i",
				function ()
					awful.util.spawn("idea")
				end,
				{description = "idea",  group = "launcher"}),
		awful.key({ modkey }, "Down", awesome.restart,
				{description = "reload awesome", group = "awesome"}),
...
--              {description = "run prompt", group = "launcher"}),
   awful.key({ modkey }, "r",
		function ()
			awful.util.spawn("ulauncher-toggle")
		end,
...
awful.rules.rules = {
	...
	{ rule = { class = "jetbrains-idea" },
		properties = {  tag = "idea", switchtotag = true } },
	{ rule = { class = "Emacs" },
		properties = {  tag = "emacs", switchtotag = true } },
	{ rule = { class = "Evince" },
		properties = {  tag = "office", switchtotag = true } },
	{ rule = { class = "VirtualBox Machine" },
		properties = {  tag = "vbox", switchtotag = true } },
	{ rule = { class = "VirtualBox Manager" },
		properties = {  tag = "vbox", switchtotag = true } },
	{ rule = { class = "Emacs" },
		properties = {  tag = "emacs", switchtotag = true } },
	{ rule = { class = "Google-chrome"},
		properties = {  tag = "chrome", switchtotag = true } },
	...
	{ rule = { class = "Acroread"},
		properties = {  tag = "office", switchtotag = true } },
	{ rule = { class = "ktorrent"},
		properties = {  tag = "amuse", switchtotag = false} },
	{ rule = { class = "netease-cloud-music"},
		properties = {  tag = "amuse" } },
	{ rule = { class = "Conky"},
